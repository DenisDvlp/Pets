...
#define INIT_CHANNEL_SHIFT(�HANNEL, BYTE_NUM) constexpr size_t �HANNEL##_SHIFT = BITS_IN_BYTE * BYTE_NUM;
...
#define INT_CHANNEL(IN, �HANNEL) (static_cast<uint32>(IN) << �HANNEL##_SHIFT)

#define INIT_CHANNEL_MASK(�HANNEL) constexpr uint32 �HANNEL##_MASK = INT_CHANNEL(0xFF, �HANNEL);
...
#define GET_CHANNEL(IN, �HANNEL) ((IN & �HANNEL##_MASK) >> �HANNEL##_SHIFT)
#define SET_CHANNEL(OUT, IN, �HANNEL) OUT &= ~static_cast<uint32>(�HANNEL##_MASK) | INT_CHANNEL(IN, �HANNEL)
